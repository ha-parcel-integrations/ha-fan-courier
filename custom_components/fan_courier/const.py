"""Constants for the FAN Courier parcel tracker integration."""
...
CAPABILITIES = frozenset({"weight", "dimensions", "pickup_point", "url", "history"})
...
# Public, unauthenticated form endpoint. It expects a URL-encoded POST body;
# it can return a list or object and answers 429 when rate limited.
TRACKING_API_URL = "https://www.fancourier.ro/limit-tracking.php"
TRACKING_URL = "https://www.fancourier.ro/awb-tracking/?tracking={tracking_code}"
