"""Tests for FAN Courier diagnostics."""
from datetime import timedelta
from unittest.mock import MagicMock

from custom_components.fan_courier.diagnostics import (
...
async def test_diagnostics_redacts_and_counts(hass):
    ...
    entry.runtime_data.coordinator.data = [
        {
            ...
            "raw": {
                "awbNumber": "EXAMPLE123456",
                "returnAwbNumber": "EXAMPLE999999",
                "confirmation": {"name": "Jane Doe"},
                "events": [{"name": "Free text", "location": "Bucuresti"}],
            },
        }
    ]
    ...
    assert result["incoming"][0]["raw"]["awbNumber"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["returnAwbNumber"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["confirmation"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["events"][0]["name"] == "**REDACTED**"
